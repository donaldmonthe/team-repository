...
class Canon(object):
    ...
    def __init__(self, boss, id, x, y, sens, coul):
        ...
        self.obus = boss.create_oval(-20, -20, -10, -10, fill='red')
...
class Pupitre(Frame):
    ...
    def __init__(self, boss, canon):
        ...
        self.regl =Scale(self, from_ =180, to =-180, troughcolor=canon.coul,
...
class Application(Frame):
    ...
    def __init__(self):
        ...
        self.pack()
        self.jeu = Canvas(self, width =750, height =700, bg ='ivory',
        bd =3, relief =SUNKEN)
        ...
        self.guns["Bradel"] = Canon(self.jeu, "Bradel", 60, 500, 1, "red")
        self.guns["wilfred"] = Canon(self.jeu, "wilfred", 700,500,-1, "blue")
        # Instanciation de 2 pupitres de pointage associés à ces canons :
        self.pupi["Bradel"] = Pupitre(self, self.guns["Bradel"])
        self.pupi["wilfred"] = Pupitre(self, self.guns["wilfred"])
    ...
    def disperser(self):
        ...
        for id in self.guns:
            ...
            gun.deplacer(x, randrange(350,640))
